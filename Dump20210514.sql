...
CREATE TABLE `book` (
  ...
  CONSTRAINT `book_ibfk_1` FOREIGN KEY (`book_category`) REFERENCES `category` (`book_category`)
...
CREATE TABLE `borroworder` (
  ...
  KEY `book_Number` (`bookNumber`),
  KEY `student_number` (`student_number`),
  CONSTRAINT `borroworder_ibfk_1` FOREIGN KEY (`bookNumber`) REFERENCES `book` (`bookNumber`),
  CONSTRAINT `borroworder_ibfk_2` FOREIGN KEY (`student_number`) REFERENCES `student` (`student_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-05-14 16:27:13
